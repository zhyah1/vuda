 ...
 * including its potential impact and recommended actions.
 *
...
const GenerateIncidentSummaryInputSchema = z.object({
  ...
  aiAnalysis: z.string().describe('The AI analysis of the incident.'),
...
const GenerateIncidentSummaryOutputSchema = z.object({
  summary: z.string().describe('A concise summary of the incident, its potential impact, and recommended actions.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant that summarizes incidents for emergency response teams.

  Given the following information about an incident, generate a concise summary of the incident, its potential impact, and recommended actions.
