...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant for a public safety platform. Your task is to analyze the provided video segment of an incident.
  
Watch the video carefully and provide the following information in the specified JSON format:
1.  **report**: A clear and concise summary of what is happening in the video. Describe the key events, people, objects, and the environment. Focus only on the events within this segment.
2.  **incidentType**: Classify the most significant event in this segment into one of the following categories: Violent Crime, Medical Emergency, Fire Alert, Traffic Accident, Suspicious Activity, Public Safety Threat, or Other. If nothing significant is happening, classify as 'Normal'.
3.  **suggestedDepartment**: Based on your analysis of this segment, suggest the single most appropriate department to handle this incident. Choose one from the following list: ${DEPARTMENTS_LIST.join(', ')}. If 'Normal', suggest 'None'.
